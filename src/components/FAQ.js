        ...
        <div id="faq" className="modal-content">
          ...
          <div className="modal-body">
            <QuestionAnswer
              ...
              answer={
                <div>
                  <p>Bitnoww is an automated cryptocurrency exchange service, operated by <a href="https://beta.companieshouse.gov.uk/company/10009845" target="_blank">YOA LTD. (registered company No. 10009845)</a>.</p>
            ...
            <QuestionAnswer
              ...
              answer={
                <p>At the moment, only the core exchange feature of our product is available for users to enjoy as part of our public beta initiative, which means that everything you see on screen works perfectly. Our goal with the beta is to expose Bitnoww to as many users as possible in order to fine-tune our design and user experience to the highest possible degree. To achieve this goal, your input as a user is invaluable. If you have any feedback for us, please feel free to contact us at <a href="mailto:support@nexchange.io">support@nexchange.io</a>.</p>
              }/>
            ...
            <QuestionAnswer
              ...
              answer={
                <div>
                  <p>In order to use Bitnoww, you need to have your own wallet. The main upside of this feature is that we don’t hold your coins, and thus you retain full control over your assets at all times.</p>
